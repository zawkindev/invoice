...
<template>
  <div class="flex flex-col w-full relative gap-2">
    ...
    <div
        class="date-picker p-4 border rounded-md dark:bg-dark1 dark:border-dark2 dark:text-white"
    >
      <div
          class="flex flex-row justify-between items-center selected-date text-xl font-normal"
      >
        <p class="text-xl">
